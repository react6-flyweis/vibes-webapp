...
import eventImageUrl from "@/assets/bg.jpg";
...
const HeroSection = () => {
  ...
  return (
    ...
    <div className="relative h-screen min-h-screen w-full bg-[#0C111F] font-sans text-white overflow-hidden">
      ...
      <img
        src={EllipseImg}
        className="w-[838.4628295898438px] absolute left-0 z-10"
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-5xl font-bold leading-tight lg:truncate">
            ...
            <span
              style={{
                backgroundImage:
                  "linear-gradient(90deg, #FDE047 0%, #F9A8D4 50%, #FFFFFF 100%)",
          ...
          <div className="lg:mt-48  mt-10 flex flex-col sm:flex-row items-center gap-4">
            ...
            >
              <span className="font-semibold text-md 2xl:text-[24px]">
                Create Event
              </span>
            ...
            >
              {slides.map((slide, index) => (
                <div key={index} className="w-full shrink-0 px-2">
                  <div className="bg-white text-black shadow-2xl overflow-hidden rounded-[69px] lg:w-[436px]">
                    <img
                      src={slide.image}
                      alt={slide.title}
