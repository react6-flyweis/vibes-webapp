...
const cardsData = [
  // Card 1: Professional Vendor Onboarding
  {
    ...
    description:
      "Complete self-service registration with AI-powered document processing.",
    features: [
      {
  ...
  // Card 2: Vendor Mobile Dashboard
  {
    ...
    description:
      "Manage your business anywhere with our React Native mobile experience.",
    features: [
      {
      ...
      },
      {
        ...
        description:
          "Track payments, view transaction history, and monitor revenue.",
      },
      {
        icon: createIcon(MessageSquare, "text-blue-600"),
        title: "Live Chat & Notifications",
        description:
          "Instant messaging with customers and real-time push notifications.",
      },
    ],
  ...
  // Card 3: AI Risk Engine & Automation
  {
    ...
    description:
      "MODULE 3: Intelligent vendor monitoring with predictive analytics.",
    features: [
      {
        icon: createIcon(CheckCircle, "text-orange-600"),
        title: "AI Profile Completeness Scoring",
        description:
          "Intelligent profile analysis with section-by-section recommendations.",
      },
      {
        icon: createIcon(BarChart, "text-orange-600"),
        title: "Smart Tiering System",
        description:
          "Automated Gold/Silver/Bronze classification based on KYC & SLA.",
      },
      {
        icon: createIcon(TrendingUp, "text-orange-600"),
        title: "Risk Monitoring & Sentiment Analysis",
        description:
          "Real-time churn prediction and review sentiment tracking.",
      },
    ],
  ...
  // Card 4: Analytics & Admin Oversight
  {
    ...
    description:
      "MODULE 5: Comprehensive admin controls and vendor performance monitoring.",
    features: [
      {
        icon: createIcon(UserCog, "text-red-600"),
        title: "Admin Moderation Panel",
        description:
          "Approve/reject profiles, review flagged content, and monitor KYC logs.",
      },
      {
        icon: createIcon(LineChart, "text-red-600"),
        title: "Performance Analytics",
        description:
          "Track SLA compliance, review ratings, booking rates, and revenue.",
      },
      {
        icon: createIcon(Zap, "text-red-600"),
        title: "Automated Alerts & Deactivation",
        description:
          "Email/SMS nudges, renewal reminders, and auto-suspension rules.",
      },
    ],
  ...
  // Card 5: Security & Compliance
  {
    ...
    description:
      "MODULE 6: Enterprise-grade security with GDPR/NDPR compliance.",
    features: [
      {
        icon: createIcon(UserCheck, "text-indigo-600"),
        title: "Role-Based Access Control",
        description:
          "Admin, Vendor, Super Admin, and Support roles with permissions.",
      },
      {
      ...
      },
      {
        ...
        description:
          "2FA authentication, audit logs, and email verification layers.",
      },
    ],
    ...
    features: [
      {
        ...
        description:
          "Track referrals with auto-bonuses for successful signups.",
      },
      {
        icon: createIcon(Bot, "text-purple-600"),
        title: "AI Chatbot & Smart Tools",
        description:
          "GPT guide, QR instant signup, social sync, ERP integration.",
      },
      {
        icon: createIcon(LineChart, "text-purple-600"),
        title: "Innovation Analytics",
        description:
          "Track referrals, chatbot stats, QR conversions, and sync rates.",
      },
    ],
