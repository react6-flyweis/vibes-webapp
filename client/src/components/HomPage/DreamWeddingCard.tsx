...
const DreamWeddingCard: React.FC = () => {
  return (
    <div className="w-full flex justify-center py-8 px-4">
      <div className="container h-auto md:h-[258px] rounded-lg border border-gray-200 shadow-2xl bg-gradient-to-r from-amber-700 via-yellow-500 to-orange-500 flex flex-col items-center justify-center text-center px-4 md:px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
          ...
          {/* Button 2 */}
          <button className="flex items-center justify-center gap-2 border border-white/50 bg-white/20 text-white px-4 sm:px-6 py-2 rounded-md backdrop-blur-sm hover:bg-white/30 transition text-sm sm:text-base">
