...
const IntegrationHub: React.FC = () => {
  return (
    <div className="font-sans p-4 sm:p-8 md:p-12 flex items-center justify-center">
      <div className="w-full container mx-auto bg-linear-to-br from-blue-50 to-blue-100 border border-blue-200 shadow-md rounded-xl p-6 sm:p-8">
        <div className="space-y-8">
          ...
          {/* Action Button */}
          <button className="w-full bg-blue-600 text-white font-medium py-3 px-6 rounded-lg flex items-center justify-center space-x-2 hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
