...
import { MoreHorizontal, Edit3, Users, Share2, Lock } from "lucide-react";
...
interface Props {
  design: SharedDesign;
  onEdit?: (design: SharedDesign) => void;
  onManageCollaborators?: (design: SharedDesign) => void;
  onShare?: (design: SharedDesign) => void;
  onPrivacy?: (design: SharedDesign) => void;
}

export function MyDesignCard({
  design,
  onEdit,
        ...
        <div className="absolute top-2 right-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem onClick={() => onManageCollaborators?.(design)}>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => onPrivacy?.(design)}>
