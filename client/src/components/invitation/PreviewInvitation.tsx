...
type StepType = "event" | "template" | "customize" | "guests" | "preview" | "send";
...
export const EventDetailsCard: React.FC<CardComponentProps> = ({ setCurrentStep }) => (
  <CardWrapper
    title="Event Details"
    ...
    <form>
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            type="text"
            defaultValue="Amazing Birthday Party"
        ...
        <div className="md:col-span-2">
          ...
          <input
            type="text"
            defaultValue="Sky Lounge Rooftop"
            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
            readOnly
          />
        </div>
        <div className="md:col-span-2">
          ...
          <textarea
            defaultValue="123 Downtown Ave, City"
            rows={2}
...
export const InvitationTemplateCard: React.FC<CardComponentProps> = ({ setCurrentStep }) => (
  <CardWrapper
    ...
    <div className="flex justify-start">
      <div className="relative bg-white rounded-lg p-3 w-72 shadow-xl border border-purple-400">
        <div className="relative rounded-md overflow-hidden h-48 mb-3">
          <img
            src="https://images.unsplash.com/photo-1543886151-3bc2b94adddc?q=80&w=1000&auto=format&fit=crop"
            alt="Neon Night AR Experience"
        ...
        <h3 className="font-bold text-lg text-gray-900">Neon Night AR Experience</h3>
        <div className="flex flex-wrap text-xs space-x-2 my-2">
          <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full">3D Neon Animation</span>
          <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full">AR Party Preview</span>
        </div>
        <div className="flex text-xs space-x-2">
          <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full">Interactive Elements</span>
        </div>
...
export const YourInvitationCard: React.FC<CardComponentProps> = ({ setCurrentStep }) => (
  <CardWrapper
...
// --- 4. Your Guests List Card ---
const guestData = [
  { name: 'Jaydon Passaquindici Arcand', email: 'jaydon@example.com', phone: '+1 778 987 2369' },
  { name: 'Miracle Torff', email: 'miracle@example.com', phone: '+1 778 987 2369' },
  { name: 'Justin Botosh', email: 'justin@example.com', phone: '+1 778 987 2369' },
];

export const GuestListCard: React.FC<CardComponentProps> = ({ setCurrentStep }) => (
  <CardWrapper
...
const PreviewInvitation: React.FC<PreviewInvitationProps> = ({ setCurrentStep }) => {
  return (
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Review all the details below. Click "Edit Details" on any card to make changes.
            </p>
          </div>
        </div>

        {/* Cards - Pass the setCurrentStep prop down to each one */}
        <EventDetailsCard setCurrentStep={setCurrentStep} />
        <InvitationTemplateCard setCurrentStep={setCurrentStep} />
        <YourInvitationCard setCurrentStep={setCurrentStep} />
        <GuestListCard setCurrentStep={setCurrentStep} />
      </div>
    </div>
  );
};
