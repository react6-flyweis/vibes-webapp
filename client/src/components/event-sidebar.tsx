...
import { Calendar, MapPin, Users, Share, UserPlus, Sparkles, Send } from "lucide-react";
...
export default function EventSidebar({ event, eventId, stats }: EventSidebarProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-xs border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium">{stats?.confirmedCount || 0} of {event.maxAttendees} people</p>
            ...
            return (
              <div key={category}>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className={categoryColors[category as keyof typeof categoryColors].replace('bg-', 'text-')}>
          ...
          {recentContributors.map((participant: any) => (
            <div key={participant.id} className="flex items-center space-x-3">
              ...
              <Badge 
                ...
                className={participant.status === "confirmed" ? "bg-party-mint text-white" : ""}
              >
                {participant.status === "confirmed" ? "Active" : participant.status}
              </Badge>
            </div>
          ))}
        </div>
      ...
      <div className="bg-linear-to-br from-party-blue to-party-turquoise rounded-xl p-6 text-white"
        ...
        <p className="text-sm opacity-90 mb-4">Discover local DJs, caterers, and party supplies</p>
        <img 
