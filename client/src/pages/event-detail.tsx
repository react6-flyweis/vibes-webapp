...
export default function EventDetail() {
  ...
  const Icon =
    categoryIcons[event.category as keyof typeof categoryIcons] || Bus;
  const categoryLabel =
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20">
              ...
              <CardContent>
                <div className="text-purple-200 text-sm">
                  Discover more amazing {categoryLabel.toLowerCase()}{" "}
                  experiences
                </div>
                <Button
                  variant="outline"
                  ...
                  onClick={() =>
                    (window.location.href = `/unique-parties?category=${event.category}`)
                  }
                >
