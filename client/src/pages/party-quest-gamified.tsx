...
export default function PartyQuestGamified() {
  ...
  const startQuestMutation = useMutation({
    mutationFn: async (questId: string) => {
      const response = await apiRequest("POST", "/api/party-quest/start", {
        questId,
      });
  ...
  const joinTeamMutation = useMutation({
    mutationFn: async (teamId: string) => {
      const response = await apiRequest("POST", "/api/party-quest/join-team", {
        teamId,
      });
      return response.json();
    },
  ...
  const filteredQuests =
    availableQuests?.filter((quest: Quest) => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-indigo-50 via-purple-50 to-pink-100 p-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Gamified guest experience with quests, rewards, and team
                  challenges
                </p>
              </div>
            </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <Button
                      key={filter.id}
                      variant={
                        questFilter === filter.id ? "default" : "outline"
                      }
                      size="sm"
                      ...
                      {quest.requirements.slice(0, 3).map((req) => (
                        ...
                        >
                          <span className="flex items-center space-x-2">
                            ...
                            <span
                              className={
                                req.completed >= req.count ? "line-through" : ""
                              }
                            >
                              {req.description}
                            </span>
                  ...
                  {userTeam ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 mb-4">
                        Team up with other guests for collaborative quests and
                        higher rewards!
                      </p>
                        ...
                        .map((teamEntry: TeamLeaderboard) => (
                          ...
                          >
                            ...
                            <Button
                              ...
                              variant="outline"
                              onClick={() =>
                                joinTeamMutation.mutate(teamEntry.team.id)
                              }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <ScrollArea className="h-96">
                    <div className="space-y-3">
                      {leaderboard?.teams?.map(
                        (teamEntry: TeamLeaderboard, index: number) => (
                          <div
                            key={teamEntry.team.id}
                            className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg"
                          >
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-sm text-gray-600">
                                {teamEntry.questsCompleted} quests
                              </div>
                            </div>
                          </div>
                        )
          ...
          <TabsContent value="rewards" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {userProgress?.nftCollection
                      ?.slice(0, 3)
                      .map((nft: any, index: number) => (
                        <div
                          key={index}
                          className="flex items-center space-x-3 p-2 bg-linear-to-r from-purple-100 to-pink-100 rounded-lg"
                        >
                          <div className="w-12 h-12 bg-linear-to-br from-purple-400 to-pink-400 rounded-lg flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Join a team and complete 3 social quests",
                  icon: <Users className="h-6 w-6" />,
                  unlocked: true,
                },
                {
                  name: "Explorer",
                  description: "Visit all party booths",
                  icon: <MapPin className="h-6 w-6" />,
                  unlocked: false,
                },
                {
                  name: "Dance Master",
                  description: "Dance 10 times during the party",
                  icon: <Music className="h-6 w-6" />,
                  unlocked: false,
                },
                {
                  name: "Photographer",
                  description: "Take and tag 5 photos",
                ...
                {
                  name: "Team Captain",
                  description: "Create a team and complete 5 team quests",
