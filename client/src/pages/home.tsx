        ...
        <div className="container mx-auto px-4 py-8">
              ...
              <Card className="hover:shadow-lg transition-all duration-300 bg-linear-to-r from-blue-600 to-purple-600 text-white cursor-pointer">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-blue-100">
                    Discover amazing events worldwide and book instantly
                  </p>
              ...
              <Card className="hover:shadow-lg transition-all duration-300 bg-linear-to-r from-green-600 to-teal-600 text-white cursor-pointer">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-green-100">
                    Plan and organize unforgettable experiences
                  </p>
              ...
              <Card className="hover:shadow-lg transition-all duration-300 bg-linear-to-r from-orange-600 to-red-600 text-white cursor-pointer">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-orange-100">
                    Connect with professional event vendors
                  </p>
                ...
                <Link to="/nft-guest-passes">
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer bg-white/10 backdrop-blur-sm border-white/20">
                    <CardHeader className="text-center">
                      ...
                      <CardDescription className="text-purple-100">
                        Evolving guest passes that level up
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </Link>
                ...
                <Link to="/sustainability-badges">
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer bg-white/10 backdrop-blur-sm border-white/20">
                    <CardHeader className="text-center">
                      ...
                      <CardDescription className="text-purple-100">
                        Verified eco-friendly events
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </Link>

                <Link to="/smart-contract-escrow">
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer bg-white/10 backdrop-blur-sm border-white/20">
                    <CardHeader className="text-center">
                ...
                <Link to="/vendor-liquidity">
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer bg-white/10 backdrop-blur-sm border-white/20">
                    <CardHeader className="text-center">
                      ...
                      <CardDescription className="text-purple-100">
                        Instant vendor cash flow
                      </CardDescription>
                    </CardHeader>
                  </Card>
                </Link>

                <Link to="/branded-micro-events">
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer bg-white/10 backdrop-blur-sm border-white/20">
                    <CardHeader className="text-center">
          ...
          <Card className="mb-8 bg-linear-to-r from-blue-900 to-green-900 text-white">
            <CardHeader>
              ...
              <CardDescription className="text-blue-100">
                Find and book amazing events with AI recommendations and social
                features
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="mb-8 bg-linear-to-r from-pink-600 to-purple-600 text-white border-0 shadow-2xl">
              ...
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <CardDescription className="text-pink-100 text-lg">
                    Revolutionary immersive invitations that transform how
                    guests experience your events
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-center">
                <Link to="/interactive-live-vibes-invite">
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>
                Ground-breaking innovations that make Vibes iconic
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Link to="/vibe-curator">
                  <div className="p-4 rounded-lg bg-linear-to-br from-purple-50 to-indigo-50 hover:shadow-md transition-shadow cursor-pointer">
                    ...
                    <p className="text-sm text-gray-600">
                      Personal party strategist
                    </p>
                  </div>
                </Link>

                <Link to="/virtual-party-twin">
                  <div className="p-4 rounded-lg bg-linear-to-br from-cyan-50 to-blue-50 hover:shadow-md transition-shadow cursor-pointer">
                    ...
                    <p className="text-sm text-gray-600">
                      Metaverse party experience
                    </p>
                  </div>
                </Link>

                <Link to="/adaptive-environment">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Continue working on your celebrations
              </CardDescription>
            </CardHeader>
            <CardContent>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            The revolutionary event planning platform that combines AI-powered
            intelligence, immersive AR visualization, and seamless collaboration
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Get intelligent recommendations for themes, vendors, and guest
                experiences
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Preview decorations and layouts in your actual space using
                augmented reality
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Coordinate with guests and vendors through intelligent
                matchmaking and planning tools
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
        ...
        <Card className="bg-linear-to-r from-blue-600 to-purple-600 text-white">
          <CardContent className="text-center py-12">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join thousands of hosts creating magical experiences with
