...
export default function SystemOverview() {
  ...
  const allFeatures = [
    // Core Features
    {
      ...
      description: "Main event management dashboard",
      path: "/",
      category: "core",
      tier: "included",
    },
    {
      id: "create-event",
      name: "Create Event",
      description: "Create and plan new events",
      path: "/create-event",
      category: "core",
      tier: "included",
    },
    {
      id: "enhanced-event",
      name: "Enhanced Event Management",
      description: "Advanced event planning tools",
      path: "/enhanced-event",
      category: "core",
      tier: "payperuse",
    },
    {
      ...
      description: "Simplified event overview",
      path: "/simple-home",
      category: "core",
      tier: "included",
    },
    {
      ...
      name: "System Integration Dashboard",
      description: "Real-time system interconnectivity view",
    ...
    // AI & Intelligence
    {
      ...
      description: "AI-powered event design and planning",
      path: "/ai-party-designer",
      category: "ai",
      tier: "payperuse",
    },
    {
      id: "ai-theme-generator",
      name: "AI Theme Generator",
      description: "Intelligent theme creation",
    ...
    },
    {
      ...
      description: "Predictive event modeling",
    ...
    },
    {
      ...
      description: "Dynamic environment adjustments",
    ...
    // Web3 & Blockchain
    {
      ...
      description: "Blockchain payment security",
    ...
    },
    {
      ...
      description: "Blockchain access management",
    ...
    },
    {
      ...
      description: "Crypto VIP access control",
    ...
    },
    {
      id: "event-dao",
      name: "Event DAO",
      description: "Decentralized event organization",
      path: "/event-dao",
      category: "web3",
      tier: "payperuse",
    },
    ...
    // AR/VR Experience
    {
      ...
      description: "Augmented reality space planning",
    ...
    },
    {
      ...
      description: "Complete VR/AR experiences",
      path: "/ar-vr-immersive",
      category: "immersive",
      tier: "payperuse",
    },
    {
      id: "virtual-party-twin",
      name: "Virtual Party Twin",
      description: "Digital event simulation",
    ...
    },
    {
      id: "ar-preview",
      name: "AR Preview",
      description: "Preview events in AR",
      path: "/ar-preview",
      category: "immersive",
      tier: "payperuse",
    },
    ...
    // Enterprise Solutions
    {
      ...
      description: "Complete enterprise feature bundle",
    ...
    },
    {
      ...
      description: "Enterprise analytics and management",
    ...
    },
    {
      id: "pricing",
      name: "Pricing Plans",
      description: "View pay-as-you-go pricing options",
      path: "/pricing",
      category: "enterprise",
      tier: "included",
    },
    ...
    // Marketplace & Vendors
    {
      ...
      description: "Professional vendor marketplace",
      path: "/vendors",
    ...
    },
    {
      ...
      description: "Professional vendor registration",
      path: "/vendor-onboarding",
      category: "marketplace",
      tier: "payperuse",
    },
    {
      id: "staffing-marketplace",
      name: "Staffing Marketplace",
      description: "Premium staffing solutions",
    ...
    },
    {
      ...
      description: "Enterprise catering solutions",
    ...
    {
      id: "vendor-liquidity",
      name: "Vendor Liquidity",
      description: "Financial vendor solutions",
    ...
    // Social & Engagement
    {
      id: "guest-matchmaking",
      name: "Guest Matchmaking",
      description: "AI-powered guest connections",
      path: "/guest-matchmaking",
      category: "social",
      tier: "payperuse",
    },
    {
      id: "interactive-mood-visualizer",
    ...
    {
      id: "gamified-attendance-rewards",
      name: "Attendance Rewards",
      description: "Gamified engagement system",
    ...
    },
    {
      ...
      description: "Guest loyalty program",
    ...
    // Creative & Design
    {
      ...
      description: "Professional invitation design",
      path: "/vibescard-studio",
      category: "creative",
      tier: "payperuse",
    },
    {
      id: "interactive-live-vibes-invite",
      name: "Interactive Invitations",
      description: "Dynamic invitation system",
      path: "/interactive-live-vibes-invite",
      category: "creative",
      tier: "payperuse",
    },
    {
      id: "social-story-templates",
    ...
    {
      id: "event-soundtrack-generator",
      name: "Soundtrack Generator",
    ...
    {
      id: "sustainability-badges",
      name: "Sustainability Badges",
      description: "Environmental achievement system",
      path: "/sustainability-badges",
      category: "core",
      tier: "payperuse",
    },
    {
      id: "livestream-companion",
      name: "Livestream Companion",
    ...
    {
      id: "live-music-voting",
      name: "Live Music Voting",
      description: "Interactive music selection",
      path: "/live-music-voting",
      category: "social",
      tier: "payperuse",
    },
    {
      id: "enhanced-dj-booth",
      name: "Enhanced DJ Booth",
      description: "Professional DJ management",
      path: "/enhanced-dj-booth",
      category: "creative",
      tier: "payperuse",
    },
    {
      id: "adaptive-music-engine",
      name: "Adaptive Music Engine",
      description: "AI music adaptation",
      path: "/adaptive-music-engine",
      category: "ai",
      tier: "payperuse",
    },
    {
      id: "nightclub-experience",
      name: "Nightclub Experience",
      description: "Premium nightclub-style events",
      path: "/nightclub-experience",
      category: "immersive",
      tier: "payperuse",
    },
    {
      id: "event-verification-badges",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Complete overview of all Vibes features organized by category with
          ...
          <TabsContent value="overview" className="space-y-6">
                ...
                return (
                  <Card key={category.id} className="relative overflow-hidden">
                    <CardHeader className="pb-4">
                      <div
                        className={`p-3 rounded-lg w-fit ${getColorClasses(
                          category.color
                        )}`}
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  <div className="text-2xl font-bold text-green-600">
                    {allFeatures.filter((f) => f.tier === "included").length}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Included Features
                  </div>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  <div className="text-2xl font-bold text-blue-600">
                    {allFeatures.filter((f) => f.tier === "payperuse").length}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Pay-Per-Use
                  </div>
                            ...
                            <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
                              <CardContent className="p-4">
                                <div className="flex justify-between items-start mb-2">
                                  ...
                                  <Badge
                                    className={`text-xs ${getTierBadgeColor(
                                      feature.tier
                                    )}`}
                                  >
                                    {feature.tier}
          ...
          <TabsContent value="features" className="space-y-6">
            ...
            <div className="flex justify-between items-center mb-4">
              <p className="text-sm text-muted-foreground">
                Showing {filteredFeatures.length} of {allFeatures.length}{" "}
                features
              </p>
            </div>
