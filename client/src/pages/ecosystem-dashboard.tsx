          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{metrics?.dataFlowRate || 0}/min</div>
                  <p className="text-xs text-muted-foreground">
                ...
                <div className="space-y-4">
                  {systemServices.map((service, index) => (
                    <div key={service.name} className="flex items-center space-x-4">
                      <div className={`w-3 h-3 rounded-full ${getStatusColor('healthy')}`}></div>
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card className="p-4">
                      <h3 className="font-semibold mb-4">Event Creation Flow</h3>
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
                          <span className="text-sm">VibeInvite creates event</span>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Design Studio generates templates</span>
                        </div>
                        <div className="flex items-center space-x-2 ml-5">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Venue Showcase suggests locations</span>
                        </div>
                        <div className="flex items-center space-x-2 ml-5">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Seat Tracker optimizes layout</span>
                        </div>
                      </div>
                    </Card>

                    <Card className="p-4">
                      <h3 className="font-semibold mb-4">Guest Experience Flow</h3>
                      <div className="space-y-3">
                        <div className="flex items-center space-x-2">
                          <div className="w-3 h-3 bg-pink-500 rounded-full"></div>
                          <span className="text-sm">Guest receives invitation</span>
                        </div>
                        <div className="flex items-center space-x-2 ml-5">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Views 3D venue preview</span>
                        </div>
                        <div className="flex items-center space-x-2 ml-5">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">Selects preferred seating</span>
                        </div>
                        <div className="flex items-center space-x-2 ml-5">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm">RSVP confirmation sent</span>
                        </div>
                      </div>
                    </Card>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-gray-600">Events Synchronized</p>
                    ...
                    <Card className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-gray-600">Design Templates Shared</p>
                    ...
                    <Card className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-gray-600">Venue Recommendations</p>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{metrics?.activeInvitations || 156}</div>
                  <p className="text-xs text-muted-foreground">
                    +12% from last week
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{metrics?.designsCreated || 89}</div>
                  <p className="text-xs text-muted-foreground">
                    +8% from last week
                  </p>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Venues Showcased</CardTitle>
                  <MapPin className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">{metrics?.venuesShowcased || 34}</div>
                  <p className="text-xs text-muted-foreground">
                    +15% from last week
                  </p>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Seating Arranged</CardTitle>
                  <Armchair className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">{metrics?.seatingArranged || 127}</div>
                  <p className="text-xs text-muted-foreground">
                    +22% from last week
                  </p>
