  ...
  const generateStoryMutation = useMutation({
    ...
    onSuccess: (data) => {
      toast({
        ...
        description:
          "Your custom story template has been created successfully!",
      });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto leading-relaxed">
            Create stunning social media stories for your events with
            professional templates and automated sharing
          </p>
            ...
            <div className="flex items-center justify-center gap-8 mt-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600">
                  {(analytics as any).totalTemplates}
                </div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">
                  {(analytics as any).storiesGenerated}
                </div>
                <div className="text-gray-600 dark:text-gray-400">
                  Stories Created
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    templates.length > 0 ? (
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {(templates as any[]).map((template) => (
                          ...
                          >
                            <div className="aspect-9/16 bg-linear-to-br from-purple-100 to-blue-100 dark:from-purple-900 dark:to-blue-900 flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <Button
                  ...
                  disabled={
                    !selectedTemplate || generateStoryMutation.isPending
                  }
                  className="w-full"
                  size="lg"
                >
                ...
                generatedStories.length > 0 ? (
                        ...
                        <CardContent className="p-4">
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              {platformIcons[
                                story.platform as keyof typeof platformIcons
                              ] && (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-4">
                      Create your first social media story to get started
                    </p>
                    <Button
                      onClick={() => {
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-purple-600">
                        {(analytics as any)?.totalStories || "42"}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-blue-600">
                        {(analytics as any)?.averageViews || "2.4K"}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold text-green-600">
                        {(analytics as any)?.engagementRate || "4.2%"}
                      </p>
                    </div>
