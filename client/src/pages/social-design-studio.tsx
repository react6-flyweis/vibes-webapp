...
export default function SocialDesignStudio() {
  ...
  const [previewMode, setPreviewMode] = useState<'design' | 'mockup' | 'animation'>('design');
  ...
  const [currentDesignType, setCurrentDesignType] = useState('birthday-celebration');
  ...
  const switchDesign = (designType: string) => {
    if (sampleDesigns[designType as keyof typeof sampleDesigns]) {
      ...
      setElements(sampleDesigns[designType as keyof typeof sampleDesigns].elements);
  ...
  const generateMockup = (platform: SocialPlatform) => {
    ...
    const mainTitle = textElements.find(el => el.style.fontSize && el.style.fontSize > 30)?.content || 'Event Title';
    const subtitle = textElements.find(el => el.style.fontSize && el.style.fontSize <= 30 && el.style.fontSize > 18)?.content || 'Event Details';
      ...
      <div className="relative bg-gray-900 p-4 rounded-lg">
        <div className="bg-gray-800 rounded-lg p-3 mb-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <div className="text-white font-medium text-sm">vibes_party_app</div>
          ...
          <div 
            ...
            style={{ 
              ...
              maxWidth: '300px',
              background: backgroundElement?.style.background || 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
          ...
          >
            ...
            <div 
              ...
              style={{
                top: `${(platform.specs.safeZones.top / platform.dimensions.height) * 100}%`,
                left: `${(platform.specs.safeZones.left / platform.dimensions.width) * 100}%`,
                right: `${(platform.specs.safeZones.right / platform.dimensions.width) * 100}%`,
                bottom: `${(platform.specs.safeZones.bottom / platform.dimensions.height) * 100}%`
              }}
            />
          ...
          <div className="text-white text-sm mt-2">
            <span className="font-medium">{Math.floor(Math.random() * 2000) + 500} likes</span>
          </div>
          
          <div className="text-white text-sm mt-1">
            <span className="font-medium">vibes_party_app</span>
            <span className="text-gray-300 ml-2">
              {mainTitle.length > 20 ? mainTitle.substring(0, 20) + '...' : mainTitle} 
  ...
  return (
    <div className="min-h-screen bg-[#111827]">
      ...
      {confettiActive && (
        <div className="fixed inset-0 pointer-events-none z-50">
          {[...Array(50)].map((_, i) => (
            <div
              key={i}
              className="absolute w-2 h-2 bg-gradient-to-r from-purple-400 to-pink-400 animate-bounce"
              style={{
      ...
      {/* Header */}
      <div className="bg-[#192133] shadow-sm ">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white">Social Design Studio</h1>
              <p className="text-white">Create, collaborate, and share stunning social media designs</p>
            </div>
            <div className="flex items-center gap-4">
        ...
        <div className="col-span-3 space-y-4">
          <Card className="p-4">
            ...
            <div className="space-y-2">
              <Button 
                variant={currentDesignType === 'birthday-celebration' ? 'default' : 'outline'}
                size="sm" 
              ...
              <Button 
                variant={currentDesignType === 'corporate-gala' ? 'default' : 'outline'}
                size="sm" 
                className="w-full justify-start text-xs"
              ...
              <Button 
                variant={currentDesignType === 'wedding-announcement' ? 'default' : 'outline'}
                size="sm" 
                className="w-full justify-start text-xs"
              ...
              <Button 
                variant={currentDesignType === 'holiday-party' ? 'default' : 'outline'}
                size="sm" 
                className="w-full justify-start text-xs"
              ...
              <Button 
                variant={currentDesignType === 'graduation-party' ? 'default' : 'outline'}
                size="sm" 
                className="w-full justify-start text-xs"
            ...
            <div className="space-y-4">
              <div>
                ...
                <Slider
                  ...
                  onValueChange={([value]) => setRemixSettings({...remixSettings, colorHue: value})}
                  max={360}
                  min={0}
                  step={1}
                  className="mt-2"
              ...
              <div>
                ...
                <Slider
                  ...
                  onValueChange={([value]) => setRemixSettings({...remixSettings, saturation: value})}
                  max={200}
                  min={0}
                  step={1}
                  className="mt-2"
              ...
              <div>
                ...
                <Slider
                  ...
                  onValueChange={([value]) => setRemixSettings({...remixSettings, brightness: value})}
                  max={200}
                  min={0}
                  step={1}
                  className="mt-2"
              ...
              >
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute top-6 left-0 bg-white rounded-lg shadow-lg p-3 min-w-48 z-10 border">
                        <div className="flex items-start gap-2">
                          <div className="w-6 h-6 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full flex-shrink-0" />
                ...
                {selectedPlatform && (
                  <div 
                    ...
                    style={{
                      top: `${(selectedPlatform.specs.safeZones.top / selectedPlatform.dimensions.height) * 100}%`,
                      left: `${(selectedPlatform.specs.safeZones.left / selectedPlatform.dimensions.width) * 100}%`,
                      right: `${(selectedPlatform.specs.safeZones.right / selectedPlatform.dimensions.width) * 100}%`,
                      bottom: `${(selectedPlatform.specs.safeZones.bottom / selectedPlatform.dimensions.height) * 100}%`
                    }}
                  />
                )}
              </div>
            ...
            {previewMode === 'animation' && (
              <div className="flex items-center justify-center h-96 bg-gray-100 rounded-lg">
                <div className="text-center space-y-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto flex items-center justify-center animate-pulse">
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="text-xs text-gray-600 space-y-1">
                    <div>Size: {selectedPlatform.dimensions.width}×{selectedPlatform.dimensions.height}</div>
