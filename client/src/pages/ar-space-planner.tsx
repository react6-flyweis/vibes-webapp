...
export default function ARSpacePlanner() {
  const [spaceMode, setSpaceMode] = useState<"upload" | "virtual" | "ar">(
    "virtual"
  );
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 max-w-7xl text-white">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Design your event space in 3D. Upload your venue photos or choose
            virtual rooms, then drag and drop furniture, decorations, and plan
            the perfect layout.
          </p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <Tabs
                  value={spaceMode}
                  onValueChange={(value) => setSpaceMode(value as any)}
                >
                    ...
                    <div className="text-sm space-y-2">
                      <div className="flex justify-between">
                        ...
                        <Badge variant="secondary">
                          {Math.round(guestFlowData.danceFloorActivity)}%
                        </Badge>
                      </div>
                      <div className="flex justify-between">
                        <span>Bar Traffic:</span>
                        <Badge variant="secondary">
                          {Math.round(guestFlowData.barTraffic)}%
                        </Badge>
                      </div>
                      <div className="flex justify-between">
                        <span>Seating Usage:</span>
                        <Badge variant="secondary">
                          {Math.round(guestFlowData.seatingUtilization)}%
                        </Badge>
                      </div>
                    </div>
              ...
              <CardContent className="h-full p-0">
                <div className="relative w-full h-full bg-gray-100 dark:bg-gray-800 rounded-b-lg overflow-hidden">
                  ...
                  {spaceMode === "upload" && uploadedImage ? (
                    ...
                    <div className="absolute inset-0 bg-linear-to-br from-blue-50 to-green-50 dark:from-gray-700 dark:to-gray-600">
                      <div className="absolute inset-4 border-2 border-dashed border-gray-300 dark:border-gray-500 rounded-lg">
                        <div className="absolute top-2 left-2 text-sm text-gray-500 dark:text-gray-400">
                          {
                            virtualSpaces.find((s) => s.id === selectedSpace)
                              ?.name
                          }{" "}
                  ...
                  {spaceItems.map((item) => (
                    <div
                      ...
                      style={{
                        ...
                        height: `${
                          (item.height / roomDimensions.height) * 100
                        }%`,
                    ...
                    <>
                      ...
                      {guestFlowData.bottlenecks.map((bottleneck, idx) => (
                        <div
                          ...
                          style={{
                            left: `${
                              (bottleneck.x / roomDimensions.width) * 100
                            }%`,
                            top: `${
                              (bottleneck.y / roomDimensions.height) * 100
                            }%`,
                            transform: "translate(-50%, -50%)",
                          }}
                  ...
                  {spaceItems.length === 0 && (
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center text-gray-500 dark:text-gray-400 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                        ...
                        <p className="text-sm">
                          Click the tools on the left to add tables, chairs, and
                          decorations.
                        </p>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-orange-600">
                {Math.round(
                  (roomDimensions.width * roomDimensions.height) / guestCount
                )}
              </div>
              <div className="text-sm text-gray-600 dark:text-gray-300">
                Sq Ft per Guest
