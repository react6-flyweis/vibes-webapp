    ...
    <div className="min-h-screen bg-party-gradient-1 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-5xl font-bold bg-linear-to-r from-white to-yellow-200 bg-clip-text text-transparent animate-party-wiggle">
              Welcome to Vibes!
            </h1>
            <p className="text-white/90 mt-2 text-xl font-medium">
        ...
        <Card className="mb-8 bg-party-gradient-2 text-white border-0 shadow-2xl animate-neon-glow">
          <CardHeader>
            ...
            <CardDescription className="text-white/90 text-lg">
              Next-level innovations that make Vibes the ultimate party planning
              platform
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <Link to="/events/1">
            <Card className="hover:shadow-2xl transition-all cursor-pointer bg-white/95 backdrop-blur-sm hover:scale-105 animate-party-wiggle border-2 border-party-coral/30">
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-lg font-bold text-party-dark">
                  Plan Event
                </CardTitle>
                <CardDescription className="text-party-gray">
