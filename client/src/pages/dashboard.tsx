    ...
    features: [
      {
        ...
        icon: Shield,
        description:
          "AI-powered access control with face recognition, NFT passes, and voice authentication",
        status: "active",
        usage: "247 entries today",
      },
      {
        ...
        icon: Crown,
        description:
          "Blockchain-verified VIP access with tier-based privileges",
        status: "active",
        usage: "15 VIP passes minted",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        icon: Activity,
        description:
          "Livestream events with interactive viewer engagement and multi-platform broadcasting",
        status: "streaming",
        usage: "3 live streams active",
      },
      {
        name: "Party Quest",
        ...
        icon: Star,
        description:
          "Gamified guest experience with quests, rewards, and team challenges",
        status: "active",
        usage: "89 quests completed",
      },
      {
        ...
        icon: BarChart3,
        description:
          "AI-powered event management with real-time analytics and automation",
        status: "monitoring",
        usage: "12 events monitored",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        icon: Eye,
        description:
          "Live shopping with AR try-on features and real-time commerce during events",
        status: "active",
        usage: "$12,750 revenue today",
      },
      {
        ...
        icon: Zap,
        description:
          "QR/NFC wristband integration with vendor payment collection",
        status: "processing",
        usage: "156 transactions",
      },
      {
        ...
        icon: Users,
        description:
          "Complete vendor ecosystem with payments and service booking",
        status: "active",
        usage: "34 vendors active",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        icon: Palette,
        description:
          "Community-driven design sharing with real-time collaboration",
        status: "creating",
        usage: "67 designs shared",
      },
      {
        ...
        icon: Globe,
        description:
          "3D venue modeling with immersive event planning capabilities",
        status: "active",
        usage: "8 venues digitized",
      },
      {
        ...
        icon: Sparkles,
        description:
          "AI-powered theme generation and complete event blueprints",
        status: "generating",
        usage: "23 themes created",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        icon: Heart,
        description:
          "Authentic cultural celebration with education and community contributions",
        status: "exploring",
        usage: "8 cultures featured",
      },
      {
        ...
        icon: Crown,
        description:
          "Gamified loyalty program with tier progression and rewards",
        status: "collecting",
        usage: "234 stamps earned",
      },
      {
        ...
        icon: CheckCircle,
        description:
          "Real-time shopping with contextual offers and shoppable moments",
        status: "shopping",
        usage: "78 purchases",
      },
    ],
    ...
    features: [
      {
        ...
        icon: Activity,
        description:
          "360° recording with AR lenses and sponsor-branded filters",
        status: "recording",
        usage: "12 videos created",
      },
      {
        ...
        icon: Zap,
        description:
          "QR/NFC wristband integration with personalized drink experiences",
        status: "serving",
        usage: "89 drinks served",
      },
      {
        name: "AI DJ Companion",
        path: "/ai-dj-companion",
        icon: Users,
        description: "Real-time music curation with crowd energy analysis",
        status: "mixing",
        usage: "4 playlists active",
      },
    ],
  },
];
...
const recentEvents = [
  {
    ...
    progress: 75,
    image:
      "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&h=200&fit=crop&auto=format",
  },
  {
    id: 2,
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
        <div>
          ...
          <p className="text-muted-foreground">
            Your event planning command center. Let's create something amazing
            together.
          </p>
        </div>
        <div className="flex items-center space-x-3">
          ...
          >
            <Link to="/event-planning/1">
              <Calendar className="w-4 h-4 mr-2" />
              Event Planning
            </Link>
          </Button>
          <Button variant="outline" asChild>
            <Link to="/ecosystem-dashboard">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  ...
                  className="w-full justify-start"
                >
                  <Link to="/natural-venue-showcase">
            ...
            {recentEvents.map((event) => (
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    {new Date(event.date).toLocaleDateString()} • {event.guests}{" "}
                    guests
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
            ...
            {featuredFeatures.map((feature) => (
              ...
              >
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div
                      className={`p-3 rounded-lg bg-linear-to-r ${feature.color}`}
                    >
