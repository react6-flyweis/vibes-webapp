...
interface DecorationItem {
  id: string;
  type: 'balloons' | 'lights' | 'flowers' | 'banners' | 'centerpieces' | 'draping' | 'backdrop' | 'lighting';
  name: string;
...
export default function PartyHallDecorator() {
  ...
  const [viewMode, setViewMode] = useState<'design' | 'preview' | '3d'>('design');
  ...
  const partyThemes: PartyTheme[] = [
    {
      ...
      decorationTypes: ['white roses', 'silk draping', 'crystal centerpieces', 'string lights'],
      ambiance: 'romantic',
      description: 'Classic white and gold with flowing drapes and crystal accents'
    },
    {
      id: 'birthday-celebration',
      name: 'Birthday Celebration',
      colors: ['#FF69B4', '#FFD700', '#32CD32', '#FF6347'],
      decorationTypes: ['colorful balloons', 'confetti', 'birthday banners', 'cake table'],
      ambiance: 'festive',
      description: 'Vibrant colors with balloons, streamers, and party favorites'
    },
    {
      id: 'corporate-gala',
      name: 'Corporate Gala',
      colors: ['#1E1E1E', '#C0C0C0', '#FFD700', '#4169E1'],
      decorationTypes: ['professional draping', 'spotlight lighting', 'branded backdrops'],
      ambiance: 'sophisticated',
      description: 'Professional elegance with branded elements and ambient lighting'
    },
    {
      id: 'garden-party',
      name: 'Garden Party',
      colors: ['#98FB98', '#FFB6C1', '#FFFFE0', '#87CEEB'],
      decorationTypes: ['fresh flowers', 'garden lights', 'natural arrangements', 'outdoor draping'],
      ambiance: 'natural',
    ...
    },
    {
      ...
      decorationTypes: ['art deco elements', 'vintage centerpieces', 'gold accents', 'dramatic lighting'],
      ambiance: 'glamorous',
  ...
  const decorationCatalog = {
    balloons: [
      { name: 'Latex Balloon Clusters', colors: ['red', 'blue', 'gold', 'white'], price: 15 },
      { name: 'Foil Letter Balloons', colors: ['silver', 'gold', 'rose-gold'], price: 25 },
      { name: 'Balloon Arches', colors: ['rainbow', 'monochrome', 'gradient'], price: 85 },
      { name: 'Helium Heart Balloons', colors: ['pink', 'red', 'white'], price: 12 },
      { name: 'Number Balloons', colors: ['gold', 'silver', 'multicolor'], price: 18 }
    ],
    lighting: [
      { name: 'String Fairy Lights', colors: ['warm-white', 'cool-white', 'multicolor'], price: 35 },
      { name: 'LED Uplighting', colors: ['any-color', 'rgb-changing'], price: 45 },
      { name: 'Chandelier Rental', colors: ['crystal', 'gold', 'modern'], price: 120 },
      { name: 'Spotlight System', colors: ['white', 'colored-gels'], price: 75 },
      { name: 'Disco Ball Lighting', colors: ['classic-silver', 'led-multicolor'], price: 40 }
    ],
    flowers: [
      { name: 'Rose Centerpieces', colors: ['red', 'white', 'pink', 'mixed'], price: 65 },
      { name: 'Hydrangea Arrangements', colors: ['blue', 'white', 'pink'], price: 55 },
      { name: 'Tropical Arrangements', colors: ['bright-mixed', 'orange-red'], price: 70 },
      { name: 'Wildflower Bouquets', colors: ['mixed-pastels', 'bright-mixed'], price: 45 },
      { name: 'Orchid Displays', colors: ['white', 'purple', 'pink'], price: 80 }
    ],
    draping: [
      { name: 'Ceiling Drapes', colors: ['white', 'ivory', 'blush'], price: 150 },
      { name: 'Wall Draping', colors: ['white', 'colored', 'gradient'], price: 100 },
      { name: 'Backdrop Curtains', colors: ['solid', 'sequined', 'patterned'], price: 85 },
      { name: 'Table Runners', colors: ['satin', 'lace', 'burlap'], price: 25 },
      { name: 'Chair Covers', colors: ['white', 'colored', 'patterned'], price: 8 }
    ],
    centerpieces: [
      { name: 'Candle Arrangements', colors: ['white', 'colored', 'mixed'], price: 35 },
      { name: 'Crystal Displays', colors: ['clear', 'colored', 'mixed'], price: 75 },
      { name: 'Fruit Arrangements', colors: ['seasonal', 'tropical', 'mixed'], price: 45 },
      { name: 'Themed Sculptures', colors: ['gold', 'silver', 'colored'], price: 95 },
      { name: 'Glass Terrariums', colors: ['green', 'mixed', 'seasonal'], price: 55 }
    ]
  };
  ...
  const handleDecorationDragStart = (e: React.DragEvent, decoration: DecorationItem) => {
  ...
  const handleLocationSubmit = async () => {
    ...
    try {
      const response = await fetch(`/api/geocode?address=${encodeURIComponent(venueLocation)}`);
      if (response.ok) {
      ...
      console.error('Geocoding service unavailable. Please ensure proper API keys are configured.');
    }
  };
  ...
  const renderDecoration = (decoration: DecorationItem) => {
    const { position, rotation, scale, color, type, style, animation } = decoration;
    ...
    switch (type) {
          ...
          >
            <div className="relative">
              {style === 'arch' ? (
                ...
                >
                  <div 
                    className="absolute bottom-0 left-1/2 w-px h-4 bg-gray-400 transform -translate-x-1/2"
                  />
                </div>
              )}
            </div>
        ...
        return (
          ...
          >
            {style === 'crystal' ? (
              ...
              <div className="relative">
                <div 
                  className="w-8 h-12 bg-gradient-to-t from-gray-800 to-gray-600 rounded-t-lg"
                />
                <div 
      ...
      case 'draping':
        return (
          ...
          >
            <div 
              className="w-full h-full bg-gradient-to-b from-opacity-20 to-opacity-80 rounded-b-full"
              style={{ 
                backgroundColor: color,
        ...
        return (
          ...
          >
            <div className="relative flex flex-col items-center">
              ...
              >
                {style === 'roses' && <Flower className="w-6 h-6" style={{ color }} />}
                {style === 'candles' && <Sun className="w-6 h-6 text-yellow-400" />}
                {style === 'crystal' && <Gem className="w-6 h-6" style={{ color }} />}
              </div>
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Party Hall Decorator</h1>
              <p className="text-gray-600">Design and visualize your perfect party setup</p>
            </div>
        ...
        <div className="col-span-6">
          {showSatelliteView && venueCoordinates ? (
            <Card className="p-4 h-[600px]">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" onClick={() => setShowSatelliteView(false)}>
                    Back to Decorator
                  </Button>
                </div>
              </div>
              ...
              <div className="relative w-full h-full bg-gray-100 rounded-lg overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-lg">Satellite View Ready</h4>
                      <p className="text-gray-600 text-sm">Location: {venueCoordinates.lat.toFixed(4)}, {venueCoordinates.lng.toFixed(4)}</p>
                      <p className="text-gray-500 text-xs mt-2">
                        Satellite imagery requires Google Maps or Mapbox API keys.
                        <br />
                        Contact your administrator to configure mapping services.
                      </p>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mt-6 max-w-md">
                      <div className="bg-white p-3 rounded-lg shadow border">
                        <div className="text-sm font-medium">Building Outline</div>
                        <div className="text-xs text-gray-500">Available with API</div>
                      </div>
                      <div className="bg-white p-3 rounded-lg shadow border">
                      ...
                      <div className="bg-white p-3 rounded-lg shadow border">
                        <div className="text-sm font-medium">Nearby Landmarks</div>
                        <div className="text-xs text-gray-500">Available with API</div>
                      </div>
                    </div>
                  </div>
          ...
          <Card className="p-4 h-[600px]">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold flex items-center gap-2">
                <Eye className="w-5 h-5" />
                Party Hall - {viewMode === 'design' ? 'Design' : viewMode === 'preview' ? 'Preview' : '3D'} Mode
              </h3>
              <div className="flex gap-2">
            ...
            <div 
              className={`relative w-full h-full bg-gradient-to-b from-gray-100 to-gray-200 rounded-lg overflow-hidden transition-all duration-200 ${
                isDropZoneActive ? 'ring-4 ring-blue-400 ring-opacity-50 bg-blue-50' : ''
              }`}
              style={{
                perspective: viewMode === '3d' ? '1000px' : 'none',
                background: viewMode === 'preview' 
                  ? `linear-gradient(135deg, ${lighting.color}20, ${currentTheme?.colors[0] || '#FFE4B5'}10)`
                  : undefined
              }}
            ...
            >
              ...
              {/* Floor */}
              <div 
                className="absolute bottom-0 left-0 right-0 h-2 bg-gradient-to-r from-gray-400 to-gray-500"
                style={{
                  transform: viewMode === '3d' ? 'rotateX(90deg) translateZ(-300px)' : undefined
                }}
              />
              ...
              {viewMode === 'preview' && (
                <div 
                  ...
                  style={{
                    background: `radial-gradient(circle at 50% 30%, ${lighting.color}${Math.floor(lighting.intensity * 30).toString(16).padStart(2, '0')} 0%, transparent 50%)`,
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-50">
                  <div className="bg-blue-500 text-white px-6 py-3 rounded-lg shadow-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium">Drop decoration here</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateDecoration(selectedDecoration.id, { name: e.target.value })}
                    className="mt-1"
                  />
                </div>
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateDecoration(selectedDecoration.id, { 
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateDecoration(selectedDecoration.id, { scale: value })}
                    max={2}
                    min={0.1}
                    step={0.1}
                    className="mt-2"
                ...
                <div>
                  ...
                  <Slider
                    ...
                    onValueChange={([value]) => updateDecoration(selectedDecoration.id, { rotation: value })}
                    max={360}
                    min={0}
                    step={15}
                    className="mt-2"
